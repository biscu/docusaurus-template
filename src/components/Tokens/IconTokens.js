...
const IconItem = ({ name, size = 24, style = {}, className }) => {
    const selectedPath = svgPaths[name];
    return (
        <svg
    ...
    return (
      <div className="flex flex-col gap-6">
        <input
          ...
          className="text-[var(--ifm-heading-color)] text-lg p-4 bg-gray-100 rounded border-none focus:outline-none dark:bg-slate-900 focus:ring focus:ring-blue-300"
        />
